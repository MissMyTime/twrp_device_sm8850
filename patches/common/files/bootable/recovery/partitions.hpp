...
public:
	...
	bool Update_Size(bool Display_Error, bool Calculate_Backup_Size);          // Optionally skips recursive backup-size calculation
...
public:
	...
	void Set_Active_Slot(const string& Slot, bool force = false);             // Sets the active slot to A or B
