...
# Use the verified TWRP userspace-fastboot request. The K100PM
# bootloader consumes boot-fastboot directly; boot-recovery can be discarded
# by this boot chain and fall through to Android instead.
...
case "$recovery_args" in
    *--fastboot*) ;;
    *)
        record "E:Fastbootd: --fastboot BCB argument read-back failed."
        exit 1
        ;;
esac

record "I:Fastbootd: verified boot-fastboot + --fastboot; rebooting."
